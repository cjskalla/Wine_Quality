...
ggpairs(data = twentypercent, columns = c("fixed.acidity", "volatile.acidity", "citric.acid", "residual.sugar", "chlorides", "free.sulfur.dioxide", "total.sulfur.dioxide", "density", "pH", "sulphates", "alcohol"), lower = list(continuous = wrap("points", size = 1)))
```
